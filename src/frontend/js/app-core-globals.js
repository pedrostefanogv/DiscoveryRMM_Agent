...
const backFromNewBtnEl = document.getElementById('backFromNewBtn');
const supportListViewEl = document.getElementById('supportListView');
const supportDetailViewEl = document.getElementById('supportDetailView');
const supportNewTicketViewEl = document.getElementById('supportNewTicketView');
...
const closeTicketStarsEl = document.getElementById('closeTicketStars');
const clearRatingBtnEl = document.getElementById('clearRatingBtn');
...
const openCloseTicketBtnEl = document.getElementById('openCloseTicketBtn');
const closeTicketModalEl = document.getElementById('closeTicketModal');
const closeTicketModalCancelBtnEl = document.getElementById('closeTicketModalCancelBtn');
const closeTicketModalCancelBottomBtnEl = document.getElementById('closeTicketModalCancelBottomBtn');
...
const kbStatusBarEl = document.getElementById('kbStatusBar');
const kbListViewEl = document.getElementById('kbListView');
const kbDetailViewEl = document.getElementById('kbDetailView');
const kbBackBtn = document.getElementById('kbBackBtn');
...
const logsLineCountEl = document.getElementById('logsLineCount');
const logsSearchInputEl = document.getElementById('logsSearchInput');
...
const natsWsServerEl = document.getElementById('natsWsServer');
const natsServerHostEl = document.getElementById('natsServerHost');
const natsUseWssExternalEl = document.getElementById('natsUseWssExternal');
const allowInsecureTlsEl = document.getElementById('allowInsecureTls');
const enforceTlsHashValidationEl = document.getElementById('enforceTlsHashValidation');
const handshakeEnabledEl = document.getElementById('handshakeEnabled');
const apiTlsCertHashEl = document.getElementById('apiTlsCertHash');
const natsTlsCertHashEl = document.getElementById('natsTlsCertHash');
