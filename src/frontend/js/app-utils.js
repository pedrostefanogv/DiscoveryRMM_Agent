...
var APP_I18N_DICTIONARY = {
  "pt-br": {
    ...
    "action.reloadCatalog": "Atualizar",
    "action.home": "Inicio",
    ...
    "field.family": "Family",
    "field.os": "SO",
    "field.osVersion": "Versão",
    "field.osBuildPlatform": "Build e plataforma",
    ...
    "status.updateDeferredDetail":
      "Há uma atualização pronta, mas ela será instalada apenas quando a janela do agente estiver minimizada ou no tray (desde {since}).",
    ...
    "store.origin.winget": "Winget",
    "store.origin.chocolatey": "Chocolatey",
    "store.origin.custom": "Custom",
    "store.originTooltip.winget": "Origem: catálogo Winget (Microsoft)",
    "store.originTooltip.chocolatey": "Origem: catálogo Chocolatey",
    "store.originTooltip.custom": "Origem: app customizado (cadastro manual no servidor)",
    ...
    "support.selectDepartment": "Selecione o departamento responsável pelo atendimento",
 ...
 "support.ticketLoadError": "Erro ao abrir chamado: {error}",
    ...
    "debug.hardwareIdentityTitle": "Identidade de Hardware",
    ...
    "debug.networkToggle": "Disponível na rede",
    ...
    "chat.activity.model": "Analisando sua solicitação…",
    "chat.activity.planning": "Planejando a ação…",
    "chat.activity.executingOne": "Executando: {tool}…",
    "chat.activity.executingMany": "Executando {count} ferramentas…",
    "chat.activity.composing": "Concluindo a ação solicitada…",
    "chat.activity.composingStep": "Compondo a resposta…",
    "chat.activity.rescue": "Reconectando — reenviando resultados das ferramentas…",
    "chat.activity.fallback": "Alternando para resposta padrão…",
    "chat.activity.round": "Etapa {round} de {max}",
    "chat.activity.roundOnly": "Etapa {round}",
  ...
  "en-us": {
    ...
    "field.osBuildPlatform": "Build and platform",
    ...
    "field.lastUpdateCheck": "Last check",
    "field.pendingVersion": "Pending version",
    "field.osEdition": "Edition",
    "field.provisionedAgents": "Provisioned agents (Zero Touch)",
    "field.p2pBytes": "P2P bytes (up / down)",
    "field.p2pActive": "P2P active",
    "field.realtimeMessage": "Message",
    "logs.empty": "(no logs)",
    ...
    "status.updateDeferredDetail":
      "An update is ready but will only be installed when the agent window is minimized or in the tray (since {since}).",
    ...
    "store.origin.chocolatey": "Chocolatey",
    "store.origin.custom": "Custom",
    "store.originTooltip.winget": "Source: Winget catalog (Microsoft)",
    "store.originTooltip.chocolatey": "Source: Chocolatey catalog",
    "store.originTooltip.custom": "Source: custom app (manually registered on the server)",
    ...
    "support.selectDepartment": "Select the department responsible for the ticket",
    ...
    "debug.hardwareIdentityTitle": "Hardware Identity",
    ...
    "chat.activity.model": "Analyzing your request…",
    "chat.activity.planning": "Planning the action…",
    "chat.activity.executingOne": "Running: {tool}…",
    "chat.activity.executingMany": "Running {count} tools…",
    "chat.activity.composing": "Completing the requested action…",
    "chat.activity.composingStep": "Composing the answer…",
    "chat.activity.rescue": "Reconnecting — resending tool results…",
    "chat.activity.fallback": "Switching to standard response…",
    "chat.activity.round": "Step {round} of {max}",
    "chat.activity.roundOnly": "Step {round}",
