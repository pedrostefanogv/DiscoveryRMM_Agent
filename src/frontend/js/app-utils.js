...
var APP_I18N_DICTIONARY = {
  'pt-br': {
    ...
    'logs.subtitle': 'Terminal de logs - saida dos comandos winget',
    ...
    'provisioning.ariaLabel': 'Provisionamento do agente',
    'provisioning.badge': 'Discovery Agent',
    ...
    'store.appsAllowed': 'Apps permitidos: {count} | Com icone: {icons}',
    ...
    'debug.watchdogTitle': 'Monitor de Saude (Watchdog)',
    'debug.watchdogDescription': 'Monitoramento automatico de componentes criticos. Alertas e recuperacao automatica em caso de travamentos.',
    ...
    'debug.watchdogUnavailable': 'Watchdog nao disponivel',
    'debug.noMonitoredComponents': 'Nenhum componente monitorado',
    'debug.autoRecoverable': 'Auto-recuperavel',
    'debug.manualRecovery': 'Manual',
    'debug.noInformation': 'Sem informacoes',
    ...
    'chat.invalidInternalLink': 'Link interno invalido: {url}',
    'chat.openTicketError': 'Nao foi possivel abrir o chamado: {error}',
    'chat.watchdogMessage': 'Watchdog: {component} esta {status} - {message}',
  ...
  'en-us': {
    ...
    'store.appsAllowed': 'Allowed apps: {count} | With icon: {icons}',
    ...
    'debug.watchdogTitle': 'Health Monitor (Watchdog)',
    'debug.watchdogDescription': 'Automatic monitoring of critical components. Alerts and automatic recovery in case of hangs.',
    ...
    'debug.watchdogUnavailable': 'Watchdog unavailable',
    'debug.noMonitoredComponents': 'No monitored components',
    'debug.autoRecoverable': 'Auto-recoverable',
    'debug.manualRecovery': 'Manual',
    'debug.noInformation': 'No information',
    'debug.saving': 'Saving...',
    ...
    'chat.watchdogMessage': 'Watchdog: {component} is {status} - {message}',
