...
var APP_I18N_DICTIONARY = {
  'pt-br': {
    ...
    'provisioning.approval.message': 'Dispositivo provisionado, aguardando aprovação da equipe de TI para integração com o servidor.',
    'provisioning.approval.footnote': 'A integração será liberada automaticamente após a aprovação. Caso essa mensagem persista, entre em contato com a equipe de TI.',
    ...
    'status.couldNotLoadAgentStatus': 'Não foi possível carregar o status do agente.',
    ...
    'updates.clickCheckToList': 'Clique em "Verificar Atualizações" para listar.',
    ...
    'inventory.initialLoadingText': 'Buscando cache local e preparando os dados para exibição.',
    ...
    'inventory.searchStartupPlaceholder': 'Pesquisar startup item por nome, path, usuário ou origem',
    'inventory.autoexec': 'Autoexec',
    'inventory.installedSoftware': 'Softwares Instalados',
    'inventory.refreshSoftware': 'Atualizar softwares',
    'inventory.searchSoftwarePlaceholder': 'Pesquisar software por nome, versão, publisher, origem ou data',
    ...
    'inventory.searchConnectionsPlaceholder': 'Pesquisar por processo, porta, endereço...',
    ...
    'inventory.initialCollectFailed': 'Falha ao coletar os dados iniciais. Clique em Coletar Inventário para tentar novamente.',
    ...
    'inventory.osqueryNotDetected': 'osquery: não detectado (pacote: {packageId})',
    ...
    'support.serverNotConfigured': 'Servidor não configurado. Configure em Debug.',
    ...
    'knowledge.searchPlaceholder': 'Buscar por título, categoria, tag ou conteúdo',
    ...
    'automation.includeScriptContent': 'Incluir conteúdo de script no sync manual',
    ...
    'automation.ackResultMessage': 'ACK e RESULT são enviados imediatamente quando possível e entram em fila persistente quando o backend estiver indisponível.',
    ...
    'automation.manualSyncWithScript': 'Sync manual com conteúdo de script habilitado',
    ...
    'automation.waitingServerConfig': 'Automação aguardando configuração de servidor/token.',
    ...
    'automation.policyLoadedLocal': 'Policy local carregada sem comunicação atual com o backend.',
    ...
    'chat.systemPromptPlaceholder': 'Ex.: Responda com foco em inventário corporativo e sempre cite riscos antes de executar ações.',
    ...
    'p2p.nativeSubtitle': 'P2P nativo: descoberta, distribuicao hibrida e cache temporario',
    'p2p.status': 'Status',
    ...
    'psadt.subtitle': 'Diagnostico real de notificacoes, modulo e execucao PSAppDeployToolkit.',
    ...
    'ztc.subtitle': 'Configuracao Zero-Touch: agentes sem credenciais sao provisionados via rede P2P',
    'ztc.description': 'Agentes instalados com instalador generico (sem credenciais pre-definidas) descobrem este agente via rede P2P e recebem a configuracao automaticamente quando a feature esta ativa no servidor.',
  ...
  'en-us': {
    ...
    'provisioning.approval.message': 'Device provisioned, awaiting IT approval to integrate with the server.',
    'provisioning.approval.footnote': 'Integration will be enabled automatically after approval. If this message persists, contact the IT team.',
    ...
    'inventory.searchSoftwarePlaceholder': 'Search software by name, version, publisher, source or date',
    ...
    'p2p.nativeSubtitle': 'Native P2P: discovery, hybrid distribution and temporary cache',
    'p2p.status': 'Status',
    ...
    'psadt.title': 'PSADT Debug Window',
    'psadt.subtitle': 'Real-time diagnostics for PSAppDeployToolkit notifications, module and execution.',
    ...
    'ztc.subtitle': 'Zero-Touch Config: agents without credentials are provisioned via P2P network',
    'ztc.description': 'Agents installed with a generic installer (no predefined credentials) discover this agent via P2P network and receive configuration automatically when the feature is active on the server.',
