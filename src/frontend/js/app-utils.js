...
var APP_I18N_DICTIONARY = {
 ...
 "support.ticketLoadError": "Erro ao abrir chamado: {error}",
    ...
    "chat.activity.connecting": "Conectando ao servidor…",
    "chat.activity.model": "Consultando o modelo de IA…",
  ...
  "en-us": {
    ...
    "chat.activity.connecting": "Connecting to the server…",
    "chat.activity.model": "Querying the AI model…",
