...
var APP_I18N_DICTIONARY = {
  'pt-br': {
    ...
    'status.serviceTitle': 'Runtime local (tray icon)',
    ...
    'status.serviceOk': 'Runtime local ativo',
    'status.serviceUnavailable': 'Runtime local indisponivel',
    'status.serviceUnavailableDetail': 'Nao foi possivel comunicar com o runtime local do Discovery. Reinicie o computador e tente novamente. Se o problema persistir, contate o suporte.',
    'status.localRuntimeMode': 'Runtime local (tray icon)',
    ...
    'status.serviceIndicator': 'Runtime: {label}',
  ...
  'en-us': {
    ...
    'status.serviceTitle': 'Local runtime (tray icon)',
    ...
    'status.serviceOk': 'Local runtime active',
    'status.serviceUnavailable': 'Local runtime unavailable',
    'status.serviceUnavailableDetail': 'Could not communicate with the local Discovery runtime. Restart the computer and try again. If the problem persists, contact support.',
    'status.localRuntimeMode': 'Local runtime (tray icon)',
