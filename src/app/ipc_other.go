...
func StartIPCServer(onMessage func(IPCMessage)) *IPCServer { return nil }
...
func NewIPCClient(onMessage func(IPCMessage), onStateChange func(bool)) *IPCClient { return &IPCClient{} }
