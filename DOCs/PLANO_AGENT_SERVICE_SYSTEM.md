...
### 7.6 Ajustes finais de captura (2026-09-07) — decisão do revisor

> Revê o item "Troca dinâmica DXGI↔GDI" do §7.5: a troca automática
> bidirecional foi removida por decisão do revisor.

| Ajuste                                  | Implementação                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| --------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **GDI primário, DXGI fallback one-way** | `session_screen.go`: capturer inicial é sempre GDI (padrão MeshAgent). DXGI entra APENAS após 40 falhas consecutivas de captura GDI (~2s) e NUNCA volta. Sem troca automática por desktop seguro — `IsSecureDesktop()` mantida apenas como util de diagnóstico                                                                                                                                                                                                                                                                        |
